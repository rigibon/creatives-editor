                  ...
                  <tr>
                    ...
                    >
                      ...
                      <div className="wrap">
                        ...
                        <p className="title">
                          <span
                            style={{ color: color_text_1, fontWeight: "bold" }}
                          >
                            {text_1}
                          </span>{" "}
                          {product_title}
                      ...
                      <div className="product-image-wrap">
                        <img style={{width:product_imgSize}}
                          border="0"
                          src={product_img}
                          alt="product image"
                      ...
                      <p style={{ color: color_text }} className="feature-para">
                        ...
                        <strong>FREE!</strong> It will take you only a minute to receive
          ...
          <tr>
            <td align="center">
              ...
              >
                ...
                <a
                  href="https://opt.listarmor.com/unsub/FszpGBqOQMf8rKW7Zb4l526J"
